 ...
 * @author Wavestone
 */
public class ContainerBankInitializer extends AbstractDispatcherServletInitializer {
    ...
    protected Filter[] getServletFilters() {
        // Used to provide the ability to enter Chinese characters inside the Customer Form
